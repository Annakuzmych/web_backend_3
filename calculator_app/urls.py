...
from .views import get_messages_for_room, online_users_view,save_history_pdf,async_operations
...
urlpatterns = [
    ...
    path('save_history_pdf/', save_history_pdf, name='save_history_pdf'),
    path('async_operations/', async_operations, name='async_operations'),
